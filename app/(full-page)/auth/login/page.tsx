...
const LoginPage = () => {
    ...
    const validarLogin = () => {
        ...
        .then((response) =>{
            console.log("Sucesso")
            //codigo que armazena o token navegar pela telas
                ...
                >
                    <div className="w-full surface-card py-8 px-5 sm:px-8" style={{ borderRadius: '53px' }}>
                        <div className="text-center mb-5">
                            ...
                            <span className="text-900 text-3xl font-medium ">Bem-Vindo </span>
                            <span className="text-600 font-medium">Agenda Anake</span>
                        </div>
                        ...
                        <div>
                            ...
                            <Button label="Entrar" className="w-full p-3 text-xl" onClick={() => validarLogin()}></Button>
                        </div>
                    </div>
                </div>
            </div>
